/*
* This Code uses an Enhanced version of USER-Defined I2C Functions
* I2C Version 2.0 
*
...
* The Project was tested on Hardware and works perfectly. 
* One thing worth Noting is the fact that, sometimes the project should be REprogrammed
* Twice or More to replace existing characters prevoiusly stored in the EEPROM's Non-Volatile Memory. 
